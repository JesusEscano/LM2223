...
function sumaport() {
    portatil+=1
    document.getElementById("cpor").innerHTML = "En carrito = "+portatil;
}
function restaport() {
    if (portatil<=1){document.getElementById("cpor").innerHTML = ""}
    else {portatil-=1
    document.getElementById("cpor").innerHTML = "En carrito = "+portatil};
}
var hdd=0;
function sumahdd() {
    hdd+=1
    document.getElementById("chdd").innerHTML = "En carrito = "+hdd;
}
function restahdd() {
    if (hdd<=1){document.getElementById("chdd").innerHTML = ""}
    else {hdd-=1
    document.getElementById("chdd").innerHTML = "En carrito = "+hdd};
}
var key=0;
